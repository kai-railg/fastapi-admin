...
REDIS_PASSWORD: int = config("REDIS_PASSWORD", cast=str, default="Westwell@2020")
REDIS_SENTINELS: str = config("REDIS_SENTINELS", cast=str, default="10.3.1.176,46380;10.3.1.177,46380;10.3.1.178,46380")
